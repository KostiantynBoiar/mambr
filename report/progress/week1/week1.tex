...
One-clip frozen-encoder probe (first real embedding) & \next \\
...
\paragraph{Immediately next.} Decode 16 frames from a single clip, run the frozen VideoMAE to
get one real video embedding, and the matching audio embedding --- proving the heavy path on
one example before extracting all 6135 clips.
