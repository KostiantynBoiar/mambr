...
\bibitem{maroon} F.~Schindler et al. \emph{Mask-guided multi-stream action recognition} \textcolor{red}{(verify title)}. Applied Sciences, 14(2):514, 2024.
...
\bibitem{poser} \textcolor{red}{[PoseR authors --- verify]}. \emph{PoseR: deep-learning behavioural classification from pose.} Open Biology, 16(1):250322, 2026. doi:10.1098/rsob.250322.
\end{thebibliography}
