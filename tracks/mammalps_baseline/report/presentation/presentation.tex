...
\begin{frame}{The idea (and the novelty)}
  ...
  \begin{itemize}
    \item we \textbf{adapt} silhouette-shape to \emph{multimodal wildlife} behaviour
          recognition; and
    \item to our knowledge, the \textbf{first use of inter-animal mask contact geometry}
          (IoU, contact-boundary length, mutual occlusion) for social/contact behaviour.
  \end{itemize}
  \vfill
